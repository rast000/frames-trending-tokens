...
const handleRequest = frames(async (ctx) => {
  ...
  return {
    ...
    buttons: [
      ...
      (type != "native" ? <Button action="post" target="/uniswap?type=native">💎 ETH</Button> : null),
      (type != "usd" ? <Button action="post" target="/uniswap?type=usd">💵 USD</Button> : null),
      (type != "tx" ? <Button action="post" target="/uniswap?type=tx">🧾 Tx</Button> : null)
    ],
  };
});
